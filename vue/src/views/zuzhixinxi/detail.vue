<template>
    <div class="views-zuzhixinxi-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 组织信息详情 </span>
                    </div>
                </template>
...
<script setup>
    ...
    import { useZuzhixinxiFindById, canZuzhixinxiFindById } from "@/module";

    const route = useRoute();

    // 获取详情页面的一行数据,当url参数id变更时，自动
    const map = useZuzhixinxiFindById(route.query.id);
