<template>
    <div class="views-zuzhihuodong-add">
        <div>
...
<script setup>
    ...
    import { useZuzhihuodongCreateForm, canZuzhihuodongInsert } from "@/module";
    ...
    const { form, readMap } = useZuzhihuodongCreateForm(props.id);
    ...
    var submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canZuzhihuodongInsert(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
