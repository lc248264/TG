<template>
    <div class="views-huodongshenhe-updt">
        <div>
...
<script setup>
    ...
    import { useHuodongshenheFindById, canHuodongshenheFindById, canHuodongshenheUpdate, canZuzhihuodongFindById } from "@/module";
    ...
    const form = useHuodongshenheFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canHuodongshenheUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
