<template>
    <div class="views-ruzushenhe-updt">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 添加入组审核 </span>
                    </div>
                </template>
...
<script setup>
    ...
    import { useRuzushenheFindById, canRuzushenheFindById, canRuzushenheUpdate, canRuzushenqingFindById } from "@/module";
    ...
    const form = useRuzushenheFindById(props.id);
