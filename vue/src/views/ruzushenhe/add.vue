<template>
    <div class="views-ruzushenhe-add">
        <div>
...
<script setup>
    ...
    import { useRuzushenheCreateForm, canRuzushenheInsert } from "@/module";
    ...
    const { form, readMap } = useRuzushenheCreateForm(props.id);
