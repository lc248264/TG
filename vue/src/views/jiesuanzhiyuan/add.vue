<template>
    <div class="views-jiesuanzhiyuan-add">
        <div>
...
<script setup>
    ...
    import { useJiesuanzhiyuanCreateForm, canJiesuanzhiyuanInsert } from "@/module";
    ...
    const { form, readMap } = useJiesuanzhiyuanCreateForm(props.id);
    ...
    var submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canJiesuanzhiyuanInsert(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
