<template>
    <div class="views-jiesuanzhiyuan-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 结算志愿详情 </span>
                    </div>
                </template>
...
<script setup>
    ...
    import { useJiesuanzhiyuanFindById, canJiesuanzhiyuanFindById } from "@/module";

    const route = useRoute();

    // 获取详情页面的一行数据,当url参数id变更时，自动
    const map = useJiesuanzhiyuanFindById(route.query.id);
