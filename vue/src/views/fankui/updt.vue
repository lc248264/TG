<template>
    <div class="views-fankui-updt">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 回复反馈 </span>
                    </div>
                </template>
...
<script setup>
    ...
    import { useFankuiFindById, canFankuiFindById, canFankuiUpdate } from "@/module";
    ...
    const form = useFankuiFindById(props.id);
