<template>
    <div class="views-ruzushenqing-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 入组申请详情 </span>
                    </div>
                </template>
...
<script setup>
    ...
    import { useRuzushenqingFindById, canRuzushenqingFindById } from "@/module";

    const route = useRoute();

    // 获取详情页面的一行数据,当url参数id变更时，自动
    const map = useRuzushenqingFindById(route.query.id);
