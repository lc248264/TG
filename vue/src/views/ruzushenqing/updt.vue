<template>
    <div class="views-ruzushenqing-updt">
        <div>
...
<script setup>
    ...
    import { useRuzushenqingFindById, canRuzushenqingFindById, canRuzushenqingUpdate, canZuzhixinxiFindById } from "@/module";
    ...
    const form = useRuzushenqingFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canRuzushenqingUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
