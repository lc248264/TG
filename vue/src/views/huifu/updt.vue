...
<script setup>
    ...
    import { useHuifuFindById, canHuifuFindById, canHuifuUpdate, canTieziFindById } from "@/module";
    ...
    const form = useHuifuFindById(props.id);
