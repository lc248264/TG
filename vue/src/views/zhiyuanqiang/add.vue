<template>
    <div class="views-zhiyuanqiang-add">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" label-width="140px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="问题" prop="wenti"> <el-input type="textarea" v-model="form.wenti"></el-input> </el-form-item>
...
<script setup>
    ...
    import { useZhiyuanqiangCreateForm, canZhiyuanqiangInsert } from "@/module";
    ...
    const { form } = useZhiyuanqiangCreateForm();
    ...
    var submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canZhiyuanqiangInsert(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
                        ...
                        if (props.isHouxu) {
                            ...
                            const f = useZhiyuanqiangCreateForm();
                            extend(form, f.form);
                        }
                    } else {
