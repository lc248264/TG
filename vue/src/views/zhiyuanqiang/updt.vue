<template>
    <div class="views-zhiyuanqiang-updt">
        <div>
...
<script setup>
    ...
    import { useZhiyuanqiangFindById, canZhiyuanqiangFindById, canZhiyuanqiangUpdate } from "@/module";
    ...
    const form = useZhiyuanqiangFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canZhiyuanqiangUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
