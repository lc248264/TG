<template>
    <div class="views-guanfangzuzhi-add">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" label-width="140px" status-icon validate-on-rule-change>
                    <el-form-item
                        ...
                        prop="zhanghao"
                        required
                        :rules="[{required:true, message:'请填写账号'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'insert', module:'guanfangzuzhi', col:'zhanghao', trigger:'blur'}]"
                    >
...
<script setup>
    ...
    import { useGuanfangzuzhiCreateForm, canGuanfangzuzhiInsert } from "@/module";
    ...
    const { form } = useGuanfangzuzhiCreateForm();
    ...
    var submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canGuanfangzuzhiInsert(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
                        ...
                        if (props.isHouxu) {
                            ...
                            const f = useGuanfangzuzhiCreateForm();
                            extend(form, f.form);
                        }
                    } else {
