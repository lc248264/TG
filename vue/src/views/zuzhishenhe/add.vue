<template>
    <div class="views-zuzhishenhe-add">
        <div>
...
<script setup>
    ...
    import { useZuzhishenheCreateForm, canZuzhishenheInsert } from "@/module";
    ...
    const { form, readMap } = useZuzhishenheCreateForm(props.id);
    ...
    var submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canZuzhishenheInsert(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
