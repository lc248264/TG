<template>
    <div class="views-jiesuanshenhe-updt">
        <div>
...
<script setup>
    ...
    import { useJiesuanshenheFindById, canJiesuanshenheFindById, canJiesuanshenheUpdate, canJiesuanzhiyuanFindById } from "@/module";
    ...
    const form = useJiesuanshenheFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canJiesuanshenheUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
