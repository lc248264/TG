<template>
    <div class="views-shenheshenqing-updt">
        <div>
...
<script setup>
    ...
    import { useShenheshenqingFindById, canShenheshenqingFindById, canShenheshenqingUpdate, canHuodongshenqingFindById } from "@/module";
    ...
    const form = useShenheshenqingFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canShenheshenqingUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
