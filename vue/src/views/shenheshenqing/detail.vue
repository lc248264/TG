<template>
    <div class="views-shenheshenqing-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 审核申请详情 </span>
                    </div>
                </template>
...
<script setup>
    ...
    import { useShenheshenqingFindById, canShenheshenqingFindById } from "@/module";

    const route = useRoute();

    // 获取详情页面的一行数据,当url参数id变更时，自动
    const map = useShenheshenqingFindById(route.query.id);
