                        ...
                        <template #default="{row}">
                            <el-button-group>
                                ...
                                <el-tooltip effect="dark" content="编辑" placement="top-start"
                                    ><el-button type="success" :icon="Edit" size="small" @click="$router.push('/admin/shenheshenqing/updt?id='+row.id)"></el-button>
                                </el-tooltip>
...
<script setup>
    ...
    const loadList = (page) => {
        ...
        http.post("/api/shenheshenqing/selectPagesChuangjianren", search).then(
            (res) => {
                loading.value = false;
                if (res.code == 0) {
                    var data = res.data;
