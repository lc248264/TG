...
public class FankuiService {
    ...
    public ResponseData<Fankui> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Fankui>> selectAll(Wrapper<Fankui> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Fankui>> selectAll() {
        QueryWrapper<Fankui> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Fankui> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Fankui> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Fankui> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Fankui>> filter(Map<String, Object> map) {
        Class<Fankui> aClass = Fankui.class;
        com.jntoo.db.QueryWrapper<Fankui> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Fankui> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Fankui entityData, Map post) {
    ...
    public ResponseData<Object> update(Fankui entityData, Map post) {
        mapper.updateById(entityData);

        Integer charuid = entityData.getId();
        DB.execute("update fankui set zhuangtai='已回复' where id='" + charuid + "'");
