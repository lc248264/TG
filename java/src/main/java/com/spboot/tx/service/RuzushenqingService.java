...
@Service
public class RuzushenqingService {

    @Resource
    private RuzushenqingMapper mapper;

    public ResponseData<Ruzushenqing> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Ruzushenqing>> selectAll(Wrapper<Ruzushenqing> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Ruzushenqing>> selectAll() {
        QueryWrapper<Ruzushenqing> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Ruzushenqing> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Ruzushenqing> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Ruzushenqing> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Ruzushenqing>> filter(Map<String, Object> map) {
        Class<Ruzushenqing> aClass = Ruzushenqing.class;
        com.jntoo.db.QueryWrapper<Ruzushenqing> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Ruzushenqing> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Ruzushenqing entityData, Map post) {
    ...
    public ResponseData<Object> update(Ruzushenqing entityData, Map post) {
