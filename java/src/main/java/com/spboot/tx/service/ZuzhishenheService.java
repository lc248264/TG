...
@Service
public class ZuzhishenheService {

    @Resource
    private ZuzhishenheMapper mapper;

    public ResponseData<Zuzhishenhe> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Zuzhishenhe>> selectAll(Wrapper<Zuzhishenhe> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Zuzhishenhe>> selectAll() {
        QueryWrapper<Zuzhishenhe> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Zuzhishenhe> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Zuzhishenhe> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Zuzhishenhe> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Zuzhishenhe>> filter(Map<String, Object> map) {
        Class<Zuzhishenhe> aClass = Zuzhishenhe.class;
        com.jntoo.db.QueryWrapper<Zuzhishenhe> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Zuzhishenhe> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Zuzhishenhe entityData, Map post) {
        ...
        if (entityData.getId() != null) {
            ...
            DB.execute("update zuzhixinxi set shenhezhuangtai='" + post.get("shenhe") + "' where id='" + post.get("zuzhixinxiid") + "'");
    ...
    public ResponseData<Object> update(Zuzhishenhe entityData, Map post) {
