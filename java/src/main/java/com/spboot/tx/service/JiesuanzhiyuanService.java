...
@Service
public class JiesuanzhiyuanService {

    @Resource
    private JiesuanzhiyuanMapper mapper;

    public ResponseData<Jiesuanzhiyuan> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Jiesuanzhiyuan>> selectAll(Wrapper<Jiesuanzhiyuan> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Jiesuanzhiyuan>> selectAll() {
        QueryWrapper<Jiesuanzhiyuan> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Jiesuanzhiyuan> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Jiesuanzhiyuan> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Jiesuanzhiyuan> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Jiesuanzhiyuan>> filter(Map<String, Object> map) {
        Class<Jiesuanzhiyuan> aClass = Jiesuanzhiyuan.class;
        com.jntoo.db.QueryWrapper<Jiesuanzhiyuan> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Jiesuanzhiyuan> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Jiesuanzhiyuan entityData, Map post) {
    ...
    public ResponseData<Object> update(Jiesuanzhiyuan entityData, Map post) {
