...
@Service
public class GuanfangzuzhiService {

    @Resource
    private GuanfangzuzhiMapper mapper;

    /**
     *   根据Zhanghao字段参数获取一行数据
     */
    public Guanfangzuzhi findByZhanghao(String username) {
        // 新建官方组织模块实体类Guanfangzuzhi
        Guanfangzuzhi pojo = new Guanfangzuzhi();
        // 设置参数
        pojo.setZhanghao(username);
        // 根据实体类新建QueryWrapper查询条件类
        QueryWrapper<Guanfangzuzhi> queryWrapper = Wrappers.query(pojo);
        Guanfangzuzhi row = mapper.selectOne(queryWrapper);
        return row;
    }
     ...
     */
    public Guanfangzuzhi findByZhanghao(String username, Integer uid) {
        // 新建官方组织模块实体类Guanfangzuzhi
        Guanfangzuzhi pojo = new Guanfangzuzhi();
        // 设置参数
        pojo.setZhanghao(username);
     ...
     * 将数据转换成Session对象
     */
    public SessionUser toSession(Guanfangzuzhi user) {
        SessionUser session = new SessionUser();
        session.setId(user.getId());
        session.setUsername(user.getZhanghao());
        session.setTable("guanfangzuzhi");
        session.setRoles("官方组织");
    ...
    public ResponseData<Guanfangzuzhi> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Guanfangzuzhi>> selectAll(Wrapper<Guanfangzuzhi> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Guanfangzuzhi>> selectAll() {
        QueryWrapper<Guanfangzuzhi> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Guanfangzuzhi> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Guanfangzuzhi> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Guanfangzuzhi> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Guanfangzuzhi>> filter(Map<String, Object> map) {
        Class<Guanfangzuzhi> aClass = Guanfangzuzhi.class;
        com.jntoo.db.QueryWrapper<Guanfangzuzhi> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Guanfangzuzhi> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Guanfangzuzhi entityData, Map post) {
    ...
    public ResponseData<Object> update(Guanfangzuzhi entityData, Map post) {
