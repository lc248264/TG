...
@Service
public class HuodongshenheService {

    @Resource
    private HuodongshenheMapper mapper;

    public ResponseData<Huodongshenhe> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Huodongshenhe>> selectAll(Wrapper<Huodongshenhe> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Huodongshenhe>> selectAll() {
        QueryWrapper<Huodongshenhe> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Huodongshenhe> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Huodongshenhe> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Huodongshenhe> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Huodongshenhe>> filter(Map<String, Object> map) {
        Class<Huodongshenhe> aClass = Huodongshenhe.class;
        com.jntoo.db.QueryWrapper<Huodongshenhe> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Huodongshenhe> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Huodongshenhe entityData, Map post) {
        ...
        if (entityData.getId() != null) {
            ...
            DB.execute("update zuzhihuodong set shenhezhuangtai='" + post.get("shenhe") + "' where id='" + post.get("zuzhihuodongid") + "'");
    ...
    public ResponseData<Object> update(Huodongshenhe entityData, Map post) {
