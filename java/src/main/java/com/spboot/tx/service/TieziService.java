...
public class TieziService {
    ...
    public ResponseData<Tiezi> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Tiezi>> selectAll(Wrapper<Tiezi> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Tiezi>> selectAll() {
        QueryWrapper<Tiezi> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Tiezi> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Tiezi> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Tiezi> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Tiezi>> filter(Map<String, Object> map) {
        Class<Tiezi> aClass = Tiezi.class;
        com.jntoo.db.QueryWrapper<Tiezi> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Tiezi> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Tiezi entityData, Map post) {
    ...
    public ResponseData<Object> update(Tiezi entityData, Map post) {
